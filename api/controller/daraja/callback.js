  ...
  try {
    ...
    if (!deviceId || !eventId || !admissionNumber) {
      return res.status(400).send({
        ...
        requestParameters: {
          deviceId:
            '<The Device ID represents the Device token generated by the fcm client>',
          eventId: '<Represents the unique id of particular events>',
          admissionNumber:
            '<Admission number of the student making the payment>',
          sampleUrl: {
            callBackURL:
              'https://{BASE_URL}/api/v1/process/callback?deviceId=183avcve&eventId=133r2wrr&admissionNumber=15-1005"',
          },
        },
      });
    }
